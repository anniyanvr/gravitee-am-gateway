...
public class RepositoryTokenStore implements TokenStore {
    ...
    public OAuth2Authentication readAuthentication(OAuth2AccessToken token) {
        Optional<io.gravitee.oauth2.repository.oauth2.model.OAuth2Authentication> oAuth2Authentication
    ...
    public OAuth2AccessToken readAccessToken(String tokenValue) {
        Optional<io.gravitee.oauth2.repository.oauth2.model.OAuth2AccessToken> oAuth2AccessToken = tokenRepository.readAccessToken(tokenValue);
    ...
    public OAuth2RefreshToken readRefreshToken(String tokenValue) {
        Optional<io.gravitee.oauth2.repository.oauth2.model.OAuth2RefreshToken> oAuth2RefreshToken
    ...
    public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
        Optional<io.gravitee.oauth2.repository.oauth2.model.OAuth2AccessToken> oAuth2AccessToken = tokenRepository.getAccessToken(convert(authentication));
    ...
    public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String userName) {
        Collection<io.gravitee.oauth2.repository.oauth2.model.OAuth2AccessToken> accessTokens =
    ...
    private io.gravitee.oauth2.repository.oauth2.model.OAuth2AccessToken convert(OAuth2AccessToken _oAuth2AccessToken) {
        io.gravitee.oauth2.repository.oauth2.model.OAuth2AccessToken oAuth2AccessToken =
                new io.gravitee.oauth2.repository.oauth2.model.OAuth2AccessToken(_oAuth2AccessToken.getValue());
        ...
        if (_oAuth2RefreshToken != null) {
            io.gravitee.oauth2.repository.oauth2.model.OAuth2RefreshToken oAuth2RefreshToken =
                    new io.gravitee.oauth2.repository.oauth2.model.OAuth2RefreshToken(_oAuth2AccessToken.getRefreshToken().getValue());
    ...
    private OAuth2AccessToken convert(io.gravitee.oauth2.repository.oauth2.model.OAuth2AccessToken _oAuth2AccessToken) {
        ...
        // refresh token
        io.gravitee.oauth2.repository.oauth2.model.OAuth2RefreshToken _oAuth2RefreshToken = _oAuth2AccessToken.getRefreshToken();
        if (_oAuth2RefreshToken != null) {
    ...
    private io.gravitee.oauth2.repository.oauth2.model.OAuth2RefreshToken convert(OAuth2RefreshToken _oAuth2RefreshToken) {
        io.gravitee.oauth2.repository.oauth2.model.OAuth2RefreshToken oAuth2RefreshToken = new io.gravitee.oauth2.repository.oauth2.model.OAuth2RefreshToken(_oAuth2RefreshToken.getValue());
        if (_oAuth2RefreshToken instanceof DefaultExpiringOAuth2RefreshToken) {
    ...
    private OAuth2RefreshToken convert(io.gravitee.oauth2.repository.oauth2.model.OAuth2RefreshToken _oAuth2RefreshToken) {
    ...
    private io.gravitee.oauth2.repository.oauth2.model.OAuth2Authentication convert(OAuth2Authentication _oAuth2Authentication) {
        ...
        io.gravitee.oauth2.repository.oauth2.model.request.OAuth2Request oAuth2Request =
                new io.gravitee.oauth2.repository.oauth2.model.request.OAuth2Request();
        ...
        // user authentication
        io.gravitee.oauth2.repository.oauth2.model.authentication.Authentication userAuthentication = null;
        ...
        if (_userAuthentication != null) {
            ...
            Collection<? extends io.gravitee.oauth2.repository.oauth2.model.authority.GrantedAuthority> authorities = convert(_userAuthentication.getAuthorities());
            userAuthentication =
                    new io.gravitee.oauth2.repository.oauth2.model.authentication.UsernamePasswordAuthenticationToken(principal, credentials, authorities);
        }

        io.gravitee.oauth2.repository.oauth2.model.OAuth2Authentication oAuth2Authentication =
                new io.gravitee.oauth2.repository.oauth2.model.OAuth2Authentication(oAuth2Request, userAuthentication);

        return oAuth2Authentication;
    }

    private OAuth2Authentication convert(io.gravitee.oauth2.repository.oauth2.model.OAuth2Authentication _oAuth2Authentication) {
        // oauth2 request
        io.gravitee.oauth2.repository.oauth2.model.request.OAuth2Request _oAuth2Request = _oAuth2Authentication.getOAuth2Request();
        ...
        io.gravitee.oauth2.repository.oauth2.model.authentication.Authentication _userAuthentication = _oAuth2Authentication.getUserAuthentication();

        if (_userAuthentication != null && _userAuthentication instanceof io.gravitee.oauth2.repository.oauth2.model.authentication.UsernamePasswordAuthenticationToken) {
            Object principal = _userAuthentication.getPrincipal();
            Object credentials = _userAuthentication.getCredentials();
    ...
    private Collection<? extends GrantedAuthority> map(Collection<? extends io.gravitee.oauth2.repository.oauth2.model.authority.GrantedAuthority> _authorities) {
    ...
    private Collection<? extends io.gravitee.oauth2.repository.oauth2.model.authority.GrantedAuthority> convert(Collection<? extends GrantedAuthority> _authorities) {
        if (_authorities == null) {
            return null;
        }
        return _authorities.stream().map(a -> new io.gravitee.oauth2.repository.oauth2.model.authority.SimpleGrantedAuthority(a.getAuthority())).collect(Collectors.toList());
    }
}
