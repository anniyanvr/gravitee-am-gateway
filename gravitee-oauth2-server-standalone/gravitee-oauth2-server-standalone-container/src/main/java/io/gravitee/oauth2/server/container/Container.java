 ...
 */
package io.gravitee.oauth2.server.container;
...
import io.gravitee.oauth2.server.spring.PropertiesConfiguration;
import io.gravitee.oauth2.server.spring.StandaloneConfiguration;
...
public class Container {
    ...
    private void initializeContext() {
        LoggerFactory.getLogger(Container.class).info("Initializing Gravitee.io OAuth2 Server context...");
     ...
     */
    public void start() {
        LoggerFactory.getLogger(Container.class).info("Start Gravitee.io OAuth2 Server...");
        ...
        try {
            ...
            LoggerFactory.getLogger(Container.class).error("An unexpected error occurs while starting Gravitee.io OAuth2 Server", ex);
            stop();
        }
    }
    ...
    public void stop() {
        if (! stopped) {
            LoggerFactory.getLogger(Container.class).info("Shutting-down Gravitee.io OAuth2 Server...");
